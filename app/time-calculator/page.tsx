...
export const metadata: Metadata = {
  ...
  description: 'Time calculator to add or subtract time between values. Calculate days, hours, minutes, and seconds with ease. like 30 days from now or 90 days from now or 60 days from now or 45 days from now. Perfect for time tracking and scheduling.',
